...
import com.osquare.springboot.sample1.demo.domain.HelloWorldBean;
...
public class HelloWorldController {
	...
	public HelloWorldBean helloWorldBean() {
		return new HelloWorldBean("This message from Hello Wold Bean");
	}
	...
	@GetMapping(path="/internationalization-without-header")
	public String withoutHeaderInfo() {
